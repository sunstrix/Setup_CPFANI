...
def sync_time_ntp():
    try:
        ...
        _log("✓ Horário synchronized com ntp.br.", "OK")
    except: pass
...
def remove_widgets_taskbar():
    try:
        ...
        sid = _get_active_user_sid()
        if sid: subprocess.run(["reg", "add", f"HKU\\{sid}\\Software\\Microsoft\\Windows\\CurrentVersion\\FileExplorer", "/v", "TaskbarDa", "/t", "REG_DWORD", "/d", "0", "/f"], capture_output=True, creationflags=0x08000000)
    except: pass
